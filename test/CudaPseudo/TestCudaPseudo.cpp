...
//-------------- initialize ------------
    ...
    std::cout<< "Partial Partition error: "<< *std::max_element(diff_sq.begin(),diff_sq.end()) << std::endl;
    ...
    std::cout<< "Complementary Partial Partition error: "<< *std::max_element(diff_sq.begin(),diff_sq.end()) << std::endl;
    ...
    std::cout<< "Segment Concentration A error: "<< *std::max_element(diff_sq.begin(),diff_sq.end()) << std::endl;
    ...
    std::cout<< "Segment Concentration B error: "<< *std::max_element(diff_sq.begin(),diff_sq.end()) << std::endl;
