...
+ If your ultimate goal is to use deep learning boosted L-FTS, you may use the sample scripts of DL-FTS repository. (https://github.com/yongdd/deep-langevin-fts) (One can easily turn on/off deep learning from the scripts.) To achieve the best performance, use the DL-FTS version even though you will not exploit DL. Because DL-FTS version performs python array operation on GPU.
