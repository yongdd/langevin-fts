...
lambda_plus = 100.0
lambda_minus = 20.0
kernel_plus_k = lambda_plus/(1.0 + g_k*lambda_plus)
kernel_minus = lambda_minus/(1.0 + 2/pc.get_chi_n()*lambda_minus)
#print(kernel_plus_k[0,0,0:10])
#print(kernel_minus)
...
for scft_iter in range(0,max_scft_iter):
    ...
    w_plus_k += kernel_plus_k*g_plus_k
