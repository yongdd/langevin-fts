...
# Langevin Dynamics
langevin_dt = 0.1     # langevin step interval, delta tau*N
...
#print(kernel_minus)
#print(exp_kernel_noise)
#print(exp_kernel_minus)
#print(exp_kernel_second)
...
np.savez("data_ETDRK2_lnQ.npz", lnQ_list)
