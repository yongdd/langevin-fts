...
params = {
    ...
    "chi_n": 16,                 # Interaction parameter, Flory-Huggins params * N
    ...
    "distinct_polymers":[{      # Distinct Polymers
        ...
        "blocks":[              # Random Copolymer. Currently, Only single block random copolymer is supported.
            {"type":"random", "length":7.0/9.0, "fraction":{"A":RCP_A_frac, "B":1-RCP_A_frac},},
        ],}],
...
# Recording first a few iteration results for debugging and refactoring
    #    1    4.285E-14  [ 8.7011270E+01  8.3797779E+01  ]    -0.007024164   2.4661560E-01  [  4.3600000, 4.3600000, 4.3600000 ]
    #    2   -1.865E-14  [ 8.7167153E+01  8.3879299E+01  ]    -0.007281942   2.3431711E-01  [  4.3600000, 4.3600000, 4.3598315 ]
    #    3    2.087E-14  [ 8.7342294E+01  8.3951537E+01  ]    -0.007578146   2.2787688E-01  [  4.3600000, 4.3600000, 4.3596648 ]
    #    4    1.998E-14  [ 8.7533922E+01  8.4017982E+01  ]    -0.007901204   2.2427552E-01  [  4.3600000, 4.3600000, 4.3594972 ]
    #    5   -2.842E-14  [ 8.7740631E+01  8.4081261E+01  ]    -0.008246396   2.2205958E-01  [  4.3600000, 4.3600000, 4.3593262 ]