...
int main()
{
    try
    {
        ...
        solver_list.push_back(new CpuComputationContinuous(new CpuComputationBox({II,JJ,KK}, {Lx,Ly,Lz}, bc), molecules, propagator_analyzer, "realspace"));
        #endif
        #ifdef USE_CUDA
        solver_name_list.push_back("cuda");
        solver_name_list.push_back("cuda_reduce_memory_usage");
        solver_list.push_back(new CudaComputationContinuous(new CudaComputationBox({II,JJ,KK}, {Lx,Ly,Lz}, bc), molecules, propagator_analyzer, "realspace"));
        solver_list.push_back(new CudaComputationReduceMemoryContinuous(new CudaComputationBox({II,JJ,KK}, {Lx,Ly,Lz}, bc), molecules, propagator_analyzer, "realspace"));
        #endif
