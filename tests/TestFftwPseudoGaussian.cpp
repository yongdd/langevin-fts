...
//-------------- initialize ------------
    ...
    CpuPseudoGaussian pseudo(&sb, &pc, new FftwFFT3D(sb.get_nx()));
    ...
    //---------------- run --------------------
    std::cout<< "Running FFTW Pseudo " << std::endl;
    ...
    //for(int i=0; i<MM; i += 3)
    //    std::cout << phia[i] << ", " << phia[i+1] << ", " << phia[i+2] << "," << std::endl;
