...
int main()
{
    try
    {
        ...
        solver_list.push_back(new CudaComputationContinuous(new CudaComputationBox<double>({II,JJ}, {Lx,Ly}, bc_abs), molecules, propagator_computation_optimizer, "realspace"));
        solver_list.push_back(new CudaComputationReduceMemoryContinuous(new CudaComputationBox<double>({II,JJ}, {Lx,Ly}, bc_abs), molecules, propagator_computation_optimizer, "realspace"));
        #endif
        ...
        solver_list.push_back(new CudaComputationContinuous(new CudaComputationBox<double>({II,JJ}, {Lx,Ly}, bc_rfl), molecules, propagator_computation_optimizer, "realspace"));
        solver_list.push_back(new CudaComputationReduceMemoryContinuous(new CudaComputationBox<double>({II,JJ}, {Lx,Ly}, bc_rfl), molecules, propagator_computation_optimizer, "realspace"));
        #endif
        ...
        solver_list.push_back(new CudaComputationContinuous(new CudaComputationBox<double>({II,JJ}, {Lx,Ly}, bc_prd), molecules, propagator_computation_optimizer, "realspace"));
        solver_list.push_back(new CudaComputationReduceMemoryContinuous(new CudaComputationBox<double>({II,JJ}, {Lx,Ly}, bc_prd), molecules, propagator_computation_optimizer, "realspace"));
        #endif
