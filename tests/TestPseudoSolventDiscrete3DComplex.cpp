...
int main()
{
    try
    {
        ...
        solver_1_list.push_back(new CpuComputationDiscrete<T>(cb_1_list.end()[-1], molecules_1, propagator_computation_optimizer_1));
        #endif
        #ifdef USE_CUDA
        ...
        solver_2_list.push_back(new CpuComputationDiscrete<T>(cb_2_list.end()[-1], molecules_2, propagator_computation_optimizer_2));
        #endif
        #ifdef USE_CUDA
