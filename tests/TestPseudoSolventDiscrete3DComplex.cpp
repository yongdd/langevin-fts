...
int main()
{
    try
    {
        ...
        solver_1_list.push_back(new CpuComputationDiscrete<T>(cb_1_list.end()[-1], molecules_1, propagator_analyzer_1));
        #endif
        #ifdef USE_CUDA
        cb_1_list.push_back(new CudaComputationBox<T>({II,JJ,KK}, {Lx,Ly,Lz}, {}));
        cb_1_list.push_back(new CudaComputationBox<T>({II,JJ,KK}, {Lx,Ly,Lz}, {}));
        solver_1_list.push_back(new CudaComputationDiscrete<T>(cb_1_list.end()[-2], molecules_1, propagator_analyzer_1));
        solver_1_list.push_back(new CudaComputationReduceMemoryDiscrete<T>(cb_1_list.end()[-1], molecules_1, propagator_analyzer_1));
        #endif

        #ifdef USE_CPU_MKL
        cb_2_list.push_back(new CpuComputationBox<T>({II,JJ,KK}, {Lx,Ly,Lz}, {}));
        solver_2_list.push_back(new CpuComputationDiscrete<T>(cb_2_list.end()[-1], molecules_2, propagator_analyzer_2));
        #endif
        #ifdef USE_CUDA
        cb_2_list.push_back(new CudaComputationBox<T>({II,JJ,KK}, {Lx,Ly,Lz}, {}));
        cb_2_list.push_back(new CudaComputationBox<T>({II,JJ,KK}, {Lx,Ly,Lz}, {}));
        solver_2_list.push_back(new CudaComputationDiscrete<T>(cb_2_list.end()[-2], molecules_2, propagator_analyzer_2));
        solver_2_list.push_back(new CudaComputationReduceMemoryDiscrete<T>(cb_2_list.end()[-1], molecules_2, propagator_analyzer_2));
        #endif
