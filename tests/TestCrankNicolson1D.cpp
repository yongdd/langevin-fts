...
int main()
{
    try
    {
        ...
        solver_list.push_back(new CpuComputationContinuous(new CpuComputationBox({II}, {Lx}, bc_abs), molecules, propagator_computation_optimizer, "realspace"));
        #endif
        ...
        solver_list.push_back(new CpuComputationContinuous(new CpuComputationBox({II}, {Lx}, bc_rfl), molecules, propagator_computation_optimizer, "realspace"));
        #endif
        ...
        solver_list.push_back(new CpuComputationContinuous(new CpuComputationBox({II}, {Lx}, bc_prd), molecules, propagator_computation_optimizer, "realspace"));
        #endif
