...
int main()
{
    try
    {
        ...
        solver_list.push_back(new CpuComputationContinuous            <double>(new CpuComputationBox<double>({II}, {Lx}, bc_abs), molecules, propagator_computation_optimizer, "realspace", "", FFTBackend::MKL));
        solver_list.push_back(new CpuComputationReduceMemoryContinuous<double>(new CpuComputationBox<double>({II}, {Lx}, bc_abs), molecules, propagator_computation_optimizer, "realspace", "", FFTBackend::MKL));
        #endif
        ...
        solver_list.push_back(new CpuComputationContinuous            <double>(new CpuComputationBox<double>({II}, {Lx}, bc_rfl), molecules, propagator_computation_optimizer, "realspace", "", FFTBackend::MKL));
        solver_list.push_back(new CpuComputationReduceMemoryContinuous<double>(new CpuComputationBox<double>({II}, {Lx}, bc_rfl), molecules, propagator_computation_optimizer, "realspace", "", FFTBackend::MKL));
        #endif
        ...
        solver_list.push_back(new CpuComputationContinuous            <double>(new CpuComputationBox<double>({II}, {Lx}, bc_prd), molecules, propagator_computation_optimizer, "realspace", "", FFTBackend::MKL));
        solver_list.push_back(new CpuComputationReduceMemoryContinuous<double>(new CpuComputationBox<double>({II}, {Lx}, bc_prd), molecules, propagator_computation_optimizer, "realspace", "", FFTBackend::MKL));
        #endif
