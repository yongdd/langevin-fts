...
Usage: python benchmark_sdc_free_energy_3d.py --ds <ds>
"""
...
def run_scft_gyroid(ds, chi_n=20.0, f=0.45, nx=32, lx=3.8):
    """Run SCFT for AB diblock in gyroid phase (3D) using SDC."""
...
def main():
    ...
    print(f"Running SCFT (3D Gyroid): method=sdc, ds={args.ds}")

    result = run_scft_gyroid(args.ds)
