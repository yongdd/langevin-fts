 ...
 *
 * This test verifies that CpuSolverPseudoRQM4 correctly computes
...
int main()
{
    try
    {
        ...
        CpuSolverPseudoRQM4<double> solver_reflect(&cb_reflect, &molecules_reflect);
        ...
        CpuSolverPseudoRQM4<double> solver_absorb(&cb_absorb, &molecules_reflect);
        ...
        CpuSolverPseudoRQM4<double> solver_reflect2(&cb_reflect, &molecules_reflect);
        ...
        CpuSolverPseudoRQM4<double> solver_sym(&cb_reflect, &molecules_reflect);
        ...
        CpuSolverPseudoRQM4<double> solver_2d(&cb_2d, &molecules_reflect);
        ...
        CpuSolverPseudoRQM4<double> solver_3d(&cb_3d, &molecules_reflect);
        ...
        CpuSolverPseudoRQM4<double> solver_dct(&cb_dct, &molecules_dct);
        ...
        CpuSolverPseudoRQM4<double> solver_dft(&cb_dft, &molecules_dft);
        ...
        CpuSolverPseudoRQM4<double> solver_dst(&cb_dst, &molecules_dct);
