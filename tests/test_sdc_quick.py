#!/usr/bin/env python
"""Quick test for SDC with direct sparse solver - small grid for fast results."""
import os
...
def run_sdc_test(N_steps, chi_n=20.0, f=0.5, nx=16, lx=3.2):
...
print("Testing SDC convergence on CPU-FFTW (3D, nx=16, direct sparse solver)...")
print("=" * 60)
