...
int main()
{
    try
    {
        ...
        #ifdef USE_CPU_MKL
        solver_1_list.push_back(new CpuPseudoDiscrete(new CpuComputationBox({II,JJ,KK}, {Lx,Ly,Lz}), molecules_1, propagators_analyzer_1, new MklFFT3D({II,JJ,KK})));
        #endif
        #ifdef USE_CUDA
        solver_1_list.push_back(new CudaPseudoDiscrete(new CudaComputationBox({II,JJ,KK}, {Lx,Ly,Lz}), molecules_1, propagators_analyzer_1));
        solver_1_list.push_back(new CudaPseudoReduceMemoryDiscrete(new CudaComputationBox({II,JJ,KK}, {Lx,Ly,Lz}), molecules_1, propagators_analyzer_1));
        #endif

        #ifdef USE_CPU_MKL
        solver_2_list.push_back(new CpuPseudoDiscrete(new CpuComputationBox({II,JJ,KK}, {Lx,Ly,Lz}), molecules_2, propagators_analyzer_2, new MklFFT3D({II,JJ,KK})));
        #endif
        #ifdef USE_CUDA
        solver_2_list.push_back(new CudaPseudoDiscrete(new CudaComputationBox({II,JJ,KK}, {Lx,Ly,Lz}), molecules_2, propagators_analyzer_2));
        solver_2_list.push_back(new CudaPseudoReduceMemoryDiscrete(new CudaComputationBox({II,JJ,KK}, {Lx,Ly,Lz}), molecules_2, propagators_analyzer_2));
        #endif
