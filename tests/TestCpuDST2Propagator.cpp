 ...
 */
int run_tests(const std::string& platform, bool reduce_memory_usage)
{
    std::cout << std::fixed << std::setprecision(17);

    std::cout << "\n============================================================" << std::endl;
    std::cout << "Platform: " << platform << std::endl;
    std::cout << "Memory saving mode: " << (reduce_memory_usage ? "ON" : "OFF") << std::endl;
    std::cout << "============================================================" << std::endl;
...
int main()
{
    try
    {
        ...
        {
            // Skip CUDA for now as DST may not be supported
            // (CUDA pseudo-spectral typically only supports periodic BC)
            if (platform == "cuda")
            {
                std::cout << "\n============================================================" << std::endl;
                std::cout << "Skipping CUDA: DST-based absorbing BC requires real-space" << std::endl;
