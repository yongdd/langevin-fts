...
//     }
// }
// std::map<std::string, ComputationBlock> Propagators::superpose_propagator_of_continuous_chain(std::map<std::string, ComputationBlock> not_superposed_yet_second_map)
// {
//     // Example)
//     // 0, B:
//     //   6, 0, 6, (C)B, 1,
...
// }
// std::map<std::string, ComputationBlock> Propagators::superpose_propagator_of_discrete_chain(std::map<std::string, ComputationBlock> not_superposed_yet_second_map)
// {
...
// std::map<std::string, ComputationBlock> Propagators::superpose_propagator_common(std::map<std::string, ComputationBlock> remaining_keys, int minimum_n_segment)
// {
