...
//----------------- get_boltz_bond -------------------
void PseudoBranched::get_boltz_bond(double *boltz_bond, double bond_length_variance,
...
void PseudoBranched::get_weighted_fourier_basis(
