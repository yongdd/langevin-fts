 ...
 * @brief MKL Crystallographic FFT for z-mirror symmetry (oblique in-plane angles).
 *
...
private:
    ...
    double dct_scale_fwd_{1.0};   ///< DCT-II calibration scale
    double dct_scale_bwd_{1.0};   ///< DCT-III calibration scale
