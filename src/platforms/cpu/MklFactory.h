 ...
 * @code
 * // Create MKL factory
 * MklFactory<double> factory(false);  // reduce_memory=false for speed
 *
 ...
 *
 * @note The reduce_memory flag is accepted for API compatibility
...
public :
     ...
     *                                        "cn-adi2" (real-space)
     * @param space_group                     Space group for symmetry (optional)
