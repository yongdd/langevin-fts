                    ...
                    mix_min,  mix_init)
{
    ...
    // fields arrays
    cudaMalloc((void**)&d_w_deriv, sizeof(double)*n_var);
    cudaMalloc((void**)&d_w,       sizeof(double)*n_var);
    cudaMalloc((void**)&d_sum, sizeof(double)*n_var);
    ...
    double error_level)
{
    ...
    cudaMemcpy(d_w_deriv, w_deriv, sizeof(double)*n_var, cudaMemcpyHostToDevice);
    ...
    else
    {
        ...
        cudaMemcpy(d_w, d_w_out_hist1, sizeof(double)*n_var,cudaMemcpyDeviceToDevice);
        for(int i=0; i<n_anderson; i++)
        {
        ...
        cudaMemcpy(w, d_w, sizeof(double)*n_var,cudaMemcpyDeviceToHost);
    }
