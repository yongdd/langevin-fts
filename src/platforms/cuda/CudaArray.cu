...
void CudaArray::add(const Array& src_1, const Array& src_2)
{
    ...
    lin_comb<<<N_BLOCKS, N_THREADS>>>(this->d_data, 1.0, d_src1_data, 1.0, d_src2_data, this->size);
}
...
void CudaArray::multiply(const Array& src_1, const Array& src_2)
{
    ...
    multi_real<<<N_BLOCKS, N_THREADS>>>(this->d_data, d_src1_data, d_src2_data, 1.0, this->size);
}
...
void CudaArray::linear_scaling(const Array& src, const double a, const double b)
{
    ...
    linear_scaling_real<<<N_BLOCKS, N_THREADS>>>(this->d_data, d_src_data, a, b, this->size);
}