...
public:
    ...
    CudaComputationReduceMemoryContinuous(ComputationBox<double>* cb, Molecules *pc, PropagatorComputationOptimizer *propagator_computation_optimizer, std::string method);
