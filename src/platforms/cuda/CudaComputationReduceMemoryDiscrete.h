...
class CudaComputationReduceMemoryDiscrete : public PropagatorComputation<double>
{
private:
...
public:
    CudaComputationReduceMemoryDiscrete(ComputationBox<double>* cb, Molecules *molecules, PropagatorComputationOptimizer *propagator_computation_optimizer);
